...
Дополнительно:
    1.1 Оценка вычислительной сложности
        Вычислительная сложность алгоритма - квадратичная, O(n^2)

        На этапе рассчета всех возможных сочетаний среди всех доступных лотов алгоритм производит вложенный цикл, что
        повышает вычислительную сложность на порядок. Сложность других частей - линейная.
